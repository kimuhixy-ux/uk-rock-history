...
function renderSyncPanel(syncStatus) {
  ...
  return `
    <section class="card sync-panel">
      ...
      ${code
        ? `
          <p class="sync-panel__lead">${S.syncPanelLeadWithCode}</p>
        ...
        : `
          ...
          <form id="syncJoinForm" class="sync-join-form">
            ...
            <div class="sync-join-row">
              <input type="text" id="syncCodeInput" maxlength="32" autocapitalize="characters" autocomplete="off" placeholder="${S.syncCodePlaceholder}">
