...
// 上下は系統(ブリティッシュ・インヴェイジョン系/ブルース系/パンク系)を表す。
const POSITIONS = {
  "british-invasion": { x: 110, y: 60 },
  "blues-rock": { x: 110, y: 190 },
  "psychedelic-rock": { x: 330, y: 60 },
  "progressive-rock": { x: 550, y: 60 },
  "hard-rock": { x: 330, y: 190 },
  "heavy-metal": { x: 550, y: 190 },
  "glam-rock": { x: 330, y: 320 },
  "punk-rock": { x: 550, y: 320 },
  "post-punk-new-wave": { x: 770, y: 320 },
  "gothic-rock": { x: 650, y: 450 },
  "madchester": { x: 820, y: 450 },
  "shoegaze": { x: 980, y: 450 },
  "britpop": { x: 900, y: 580 },
  "alternative-indie": { x: 900, y: 700 },
  "other": { x: 110, y: 700 },
};
...
export async function renderGenres(view) {
  ...
  view.innerHTML = `
    ...
    <p class="page-lead">イギリスのロックシーンにおける主なジャンルの派生関係です。ノードをタップするとそのジャンルのアーティスト一覧に移動します。</p>
